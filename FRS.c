...
int get_location_id(char location[]) {
 ...
 return location_count++; // Increment location count after returning ID
}
// Main function
int main() {
...
11
 ...
 scanf("%d %s %s %d", &food_providers[food_provider_count].id,
...
&food_providers[food_provider_count].food_quantity);
 ...
 food_providers[food_provider_count].location,
 food_providers[food_provider_count].food_quantity);
 log_to_file_with_id("Added Food Provider", food_providers[food_provider_count].id,
details);
 food_provider_count++;
 break;
 }
 ...
 food_providers[i].name, food_providers[i].location,
food_providers[i].food_quantity);
 }
 break;
 }
 case 3: {
 printf("Enter NGO ID, Name, Location, and Capacity: ");
 scanf("%d %s %s %d", &ngos[ngo_count].id, ngos[ngo_count].name,
ngos[ngo_count].location,
 ...
 printf("ID: %d, Name: %s, Location: %s, Capacity: %d\n", ngos[i].id, ngos[i].name,
ngos[i].location, ngos[i].capacity);
 }
 break;
 }
 case 5: {
 printf("Enter Volunteer ID, Name, and Location: ");
 scanf("%d %s %s", &volunteers[volunteer_count].id, volunteers[volunteer_count].name,
volunteers[volunteer_count].location);
 ...
 printf("ID: %d, Name: %s, Location: %s\n", volunteers[i].id, volunteers[i].name,
